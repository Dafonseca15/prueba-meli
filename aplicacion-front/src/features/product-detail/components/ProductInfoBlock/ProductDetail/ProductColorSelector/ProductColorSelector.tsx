    ...
    return (
        ...
        >
            <CustomText as="span" size="sm" color="#0000008c" className="product-color-selector__label">
                Color: <span className="product-color-selector__selected-name" data-testid="product-color-selector__selected-name">{nameColor}</span>
            </CustomText>
            <div className="product-color-selector__options" data-testid="product-color-selector__options">
