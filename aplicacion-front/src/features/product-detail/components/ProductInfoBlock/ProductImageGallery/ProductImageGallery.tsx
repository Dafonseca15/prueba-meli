...
export const ProductImageGallery: React.FC<ProductImageGalleryProps> = ({ pictures, title }) => {
    ...
    if (!pictures || pictures.length === 0) {
        return <div className="no-images-placeholder"  data-testid="no-images-placeholder">No images available</div>;
    }
    ...
    return (
        ...
        >
            <div 
                ...
                data-testid="product-thumbnail-gallery"
                >
            ...
            <div 
                ...
                >
                    <img 
                        ...
                        data-testid="main-image-element"
                        />
            </div>
        </div>
    );
