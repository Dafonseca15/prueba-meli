...
describe("Feature: Product Details Data Fetching", () => {
  ...
  const mockProduct: Product = {
    ...
    buy_and_delivery: { delivery: { title: "Envío", description: "Desc", calculate_shipping: null, shipping_url: null }, disponibility: { title: "Disp" }, actions: [], benefits: null },
    interest: null,
    condition: "new",
    sold_quantity: 10,
    badge_info: null,
  ...
  describe("Scenario: Product ID changes", () => {
    ...
    const initialProductData: Product = { ...mockProduct, id: initialProductId, title: "Initial Product" };
